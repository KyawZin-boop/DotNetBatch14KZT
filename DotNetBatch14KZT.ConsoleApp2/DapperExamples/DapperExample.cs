...
public class DapperExample
{
    ...
    public void Read()
    {
        ...
        {
            Console.WriteLine("id = " + blog.blog_id);
            Console.WriteLine("title = " + blog.blog_title);
            Console.WriteLine("author = " + blog.blog_author);
    ...
    public void Edit(string id)
    {
        ...
        var item = connection.Query<BlogDto>($"Select * from tbl_blog where blog_id='{id}'").FirstOrDefault();
    ...
    public void Update(string id)
    {
        string query = $@"UPDATE [dbo].[tbl_blog]
                                           SET [blog_title] = 'dapperUpdateTitle1'
                                              ,[blog_author] = 'dapperUpdateAuthor1'
                                              ,[blog_content] = 'dapperUpdateContent1'
                                         WHERE blog_id = '{id}'";
